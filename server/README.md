# AI Passport Recorder upload server
...
```sh
curl -H "Authorization: Bearer $AI_PASSPORT_UPLOAD_TOKEN" \
...
The data volume is named `ai-passport-recorder-c3_passport-recordings` by default. Back up that Docker
